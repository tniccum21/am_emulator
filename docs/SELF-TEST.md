...
The self-test loops continuously. After the timer test passes, it restarts from the beginning. Tests beyond the timer test (serial ports, Winchester, floppy, etc.) require hardware that is not yet emulated and will either fail or hang.
